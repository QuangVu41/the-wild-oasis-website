...
function Cabin({ cabin }) {
  ...
  return (
    <div className='grid md:grid-cols-[3fr_4fr] gap-4 md:gap-20 border border-primary-800 px-3 py-3 md:px-10 mb-8 md:mb-24'>
      <div className='relative h-80 md:h-auto md:scale-[1.15] md:-translate-x-3'>

...
export default async function Page() {
  ...
  return (
    <div className='grid grid-cols-5 gap-y-8 md:gap-x-24 md:gap-y-32 text-lg items-center'>
      <div className='col-span-5 md:col-span-3'>
        ...
        <div className='space-y-8'>
          ...
          <p>
            Our {numCabins} luxury cabins provide a cozy base, but the real freedom and peace you&apos;ll find in the
      ...
      <div className='col-span-5 md:col-span-2 aspect-square relative '>
